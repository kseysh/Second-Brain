...
- [x] 어셈블리어로?, stack structure와 함께 설명
      ![[Pasted image 20231203160413.png]]
      ![[Pasted image 20231204164055.png]]
- [x]  `%rax`가 caller saved 여야 하는 이유
- [x]  `%rdi...%r9`가 caller saved 여야 하는 이유
...
- [ ] 가변 Array
      ![[Pasted image 20231207011100.png]]
  ## Structure
- [x] struct 주소 계산 하는 방법
- [x] 
      ![[Pasted image 20231207124931.png]]
- [x] ![[Pasted image 20231127131707.png]]
- [x] Structure의 Alignment 규칙 2가지
- [ ] 
      ![[Pasted image 20231207124844.png]]
      ![[Pasted image 20231207124853.png]]
## Union
- [x] Union과 Structure의 차이
- [x] Union Little Endian으로 표현하기
- [x] Union Big Endian으로 표현하기
## Linking
- [x] linking이 필요한 이유 두 가지
- [x] relocatable object file이란?
- [x] executable object file이란?
- [ ] shared object file이란?
- [x] ELF header란?
- [x] Segment header table이란?
- [x] .text section이란?
- [x] .rodata section이란?
- [x] .data section이란?
- [x] .bss section이란?
...
- [x] MMU의 역할
- [ ] *vm을 사용하는 이유*
- [x] Virtual Memory as a Tool for Cashing 설명과 단위
- [x] page table이란?
- [x] page hit이란?
- [x] page fault란?
- [x] Handling Page Fault 순서
- [x] Allocating Pages 설명
- [x] active하게 접근하는 virtual pages
...
- [x] VPO(Virtual Page Offset)는 번역되어야 한다? VPN(Virtual Page Number)은 번역되어야 한다?
...
- [x] ![[Pasted image 20231130175702.png]]
- [ ] ![[Pasted image 20231130175933.png]]
- [x] ![[Pasted image 20231130180145.png]]
- [x] 
...
- [x] Exception Tables란?
- [ ] 비동기적 예외란?
- [ ] Low level mechanism이란?
- [ ] Higher level mechanism이란?
