...
b. 첫 번째 주소(네트워크 주소)를 찾기 위해 AND 연산을 사용합니다. 첫 번째 주소는 167.199.170.64/27입니다.
...
ISP가 1000개의 주소 블록을 요청했습니다. 다음과 같은 블록이 할당되었습니다.
a. 1000은 2의 제곱수가 아니므로, 1024개의 주소가 할당됩니다. (1024 = ).
b. 블록의 접두사 길이는 로 계산됩니다.
